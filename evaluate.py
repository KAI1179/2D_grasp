...
def parse_args():
    ...
    parser.add_argument('--use-mask', type=int, default=1,
                        help='Use mask image for evaluation (1/0)')
    ...
    for network in args.network:
        ...
        with torch.no_grad():
            for idx, (x, y, didx, rot, zoom) in enumerate(test_data):
                ...
                q_img, ang_img, width_img, mask_out = post_process_output(lossd['pred']['pos'], lossd['pred']['cos'],
                                                                lossd['pred']['sin'], lossd['pred']['width'],
                                                                lossd['pred']['object_region'])
                ...
                if args.jacquard_output:
                    grasps = grasp.refine_detect_grasps(q_img, ang_img, width_img=width_img, no_grasps=1)
